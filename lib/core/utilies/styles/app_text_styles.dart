...
import 'package:smart_connect/core/helper/get_responsive_font_size.dart';
...
class AppTextStyles {
  ...
  static TextStyle title18GreyW500 = TextStyle(
    color: Colors.grey,
  ...
  static TextStyle title16Black500 = TextStyle(
    color: Colors.black,
    fontSize: getResponsiveFontSize(fontSize: 16),
    fontWeight: FontWeight.w500,
  );
  ...
  static TextStyle title36PrimaryColorW500 = TextStyle(
    color: AppColors.primaryColor,
